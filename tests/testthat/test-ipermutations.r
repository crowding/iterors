...
test_that("ipermutations generates m-length permutations properly", {
  ...
  expect_equal(nextOr(it, NA), c('a', 'b'))
  expect_equal(nextOr(it, NA), c('a', 'c'))
  expect_equal(nextOr(it, NA), c('a', 'd'))
  expect_equal(nextOr(it, NA), c('b', 'a'))
  expect_equal(nextOr(it, NA), c('b', 'c'))
  expect_equal(nextOr(it, NA), c('b', 'd'))
  expect_equal(nextOr(it, NA), c('c', 'a'))
  expect_equal(nextOr(it, NA), c('c', 'b'))
  expect_equal(nextOr(it, NA), c('c', 'd'))
  expect_equal(nextOr(it, NA), c('d', 'a'))
  expect_equal(nextOr(it, NA), c('d', 'b'))
  expect_equal(nextOr(it, NA), c('d', 'c'))
