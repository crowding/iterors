...
test_that("iseq with by specified", {
  ...
  expect_equal(nextElemOr(it, NA), 2)
  expect_equal(nextElemOr(it, NA), 2.6)
  expect_equal(nextElemOr(it, NA), 3.2)
  expect_equal(nextElemOr(it, NA), NA)
})
...
test_that("iseq with length_out specified", {
  ...
  expect_equal(nextElemOr(it, NA), 2)
  expect_equal(nextElemOr(it, NA), 2.375)
  expect_equal(nextElemOr(it, NA), 2.75)
  expect_equal(nextElemOr(it, NA), 3.125)
  expect_equal(nextElemOr(it, NA), 3.5)
  expect_equal(nextElemOr(it, NA), NA)
})
...
test_that("iseq for decreasing sequence with from and to specified", {
  ...
  expect_equal(nextElemOr(it, NA), 2)
  expect_equal(nextElemOr(it, NA), 1)
  expect_equal(nextElemOr(it, NA), 0)
  expect_equal(nextElemOr(it, NA), -1)
  expect_equal(nextElemOr(it, NA), -2)
  expect_equal(nextElemOr(it, NA), -3)
  expect_equal(nextElemOr(it, NA), NA)
