...
test_that("islice of integer sequence with no end specified", {
  ...
  expect_equal(nextElemOr(it, NULL), 2)
  expect_equal(nextElemOr(it, NULL), 3)
  expect_equal(nextElemOr(it, NULL), 4)
  expect_equal(nextElemOr(it, NULL), 5)
  expect_equal(nextElemOr(it, NULL), NULL)
})
...
test_that("islice of integer sequence with start, end, and step specified", {
  ...
  expect_equal(nextElemOr(it, NULL), 2)
  expect_equal(nextElemOr(it, NULL), 4)
  expect_equal(nextElemOr(it, NULL), 6)
  expect_equal(nextElemOr(it, NULL), 8)
  expect_equal(nextElemOr(it, NULL), NULL)
})
