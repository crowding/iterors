...
test_that("icombinations with replacement works correctly", {
  ...
  expect_equal(nextOr(it, NA), c(1, 1))
  expect_equal(nextOr(it, NA), c(1, 2))
  expect_equal(nextOr(it, NA), c(1, 3))
  expect_equal(nextOr(it, NA), c(1, 4))
  expect_equal(nextOr(it, NA), c(2, 2))
  expect_equal(nextOr(it, NA), c(2, 3))
  expect_equal(nextOr(it, NA), c(2, 4))
  expect_equal(nextOr(it, NA), c(3, 3))
  expect_equal(nextOr(it, NA), c(3, 4))
  expect_equal(nextOr(it, NA), c(4, 4))
