...
test_that("itripletwise functions properly with an iterator", {
  ...
  expect_equal(nextOr(it_itripletwise, NA), list("a", "b", "c"))
  expect_equal(nextOr(it_itripletwise, NA), list("b", "c", "d"))
  expect_equal(nextOr(it_itripletwise, NA), NA)
})
...
test_that("itripletwise functions properly with a vector", {
  ...
  expect_equal(nextOr(it_itripletwise, NA), list("a", "b", "c"))
  expect_equal(nextOr(it_itripletwise, NA), list("b", "c", "d"))
  expect_equal(nextOr(it_itripletwise, NA), list("c", "d", "e"))
  expect_equal(nextOr(it_itripletwise, NA), NA)
})
