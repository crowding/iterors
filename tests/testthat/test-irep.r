...
test_that("irep replicates a list and matches tenth example from base::rep", {
  ...
  expect_equal(nextElemOr(it, NA), 1:10)
  expect_equal(nextElemOr(it, NA), "squash")
  expect_equal(nextElemOr(it, NA), 1:10)
  expect_equal(nextElemOr(it, NA), "squash")
  expect_equal(nextElemOr(it, NA), 1:10)
  expect_equal(nextElemOr(it, NA), "squash")
...
test_that("irep replicates a factor and matches last example from base::rep", {
  ...
  it <- irep(x, 2)
  expect_equal(nextElemOr(it, NA), x[1])
  expect_equal(nextElemOr(it, NA), x[2])
  expect_equal(nextElemOr(it, NA), x[3])
  expect_equal(nextElemOr(it, NA), x[4])
  expect_equal(nextElemOr(it, NA), x[1])
  expect_equal(nextElemOr(it, NA), x[2])
  expect_equal(nextElemOr(it, NA), x[3])
  expect_equal(nextElemOr(it, NA), x[4])
