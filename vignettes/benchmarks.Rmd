...
first verify that those are roughly on par
...
array_chunks.bench <- microbenchmark::microbenchmark(
  ...
  itertools.iarray_rows = iter_consume(itertools::iarray(arr, MARGIN = 1, chunkSize=7)),
  itertools.iarray_cols = iter_consume(itertools::iarray(arr,MARGIN = 2, chunkSize=7)),
