...
* [`i_mask`](../reference/i_mask.html) -- Return elements for which a parallel iterator is TRUE. (FIXME where is this?)
...
* [`i_concat`](../reference/i_chain.html) -- Take all values from the list of... FIXME where is this?
