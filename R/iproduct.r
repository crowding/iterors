...
#' nextElemOr(it, NA) # list(x=1, y=4)
#' nextElemOr(it, NA) # list(x=1, y=5)
#' nextElemOr(it, NA) # list(x=2, y=4)
#' nextElemOr(it, NA) # list(x=2, y=5)
#' nextElemOr(it, NA) # list(x=3, y=4)
#' nextElemOr(it, NA) # list(x=3, y=5)
#'
